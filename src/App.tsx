...
function useLocalStorageState<T>(key: string, defaultValue: T) {
	...
	const [value, setValue] = useState<T>(valueFromLocalStorage === null ? defaultValue : JSON.parse(valueFromLocalStorage));
		...
		input: (
			...
			>
				...
				<input
					...
					onChange={(e) => setValue(defaultValue.constructor(typeof defaultValue === "boolean" ? e.target.checked : e.target.value))}
				/>
			</label>
		),
	};
